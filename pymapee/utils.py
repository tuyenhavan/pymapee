...
def initialize_ee(token_name="EARTHENGINE_TOKEN", auth_mode="notebook", service_account=False):
    ...
    Credits: This function is taken from https://github.com/gee-community/geemap
    """
    import httplib2
